...
# QCNN Model with the Unitary Z, CRX, Y gates
...
# QCNN Base Model with shared weights
...
# QCNN Model with the Unitary Z, CRX, Y gates with shared weights
...
# QCNN with Feature Maps of CRX and the Unitary Z, CRX, Y gates with shared weights
...
# QCNN with Feature Maps of CRX and the Unitary Z, CRX, Y gates with different weights
