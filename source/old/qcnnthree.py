...
class QCNN(nn.Module):
    def __init__(self, n_qubits = 8, n_cycles = 4):
        ...
        # Third Layer
        # first convolutional layer
        self.crx20 = tq.CRX(has_params=True, trainable=True)
        self.crx21 = tq.CRX(has_params=True, trainable=True)
        self.crx22 = tq.CRX(has_params=True, trainable=True)
        self.crx23 = tq.CRX(has_params=True, trainable=True)
        self.crx24 = tq.CRX(has_params=True, trainable=True)
        self.crx25 = tq.CRX(has_params=True, trainable=True)
        self.crx26 = tq.CRX(has_params=True, trainable=True)
        ...
        # second convolutional layer
        self.crx27 = tq.CRX(has_params=True, trainable=True)
        self.crx28 = tq.CRX(has_params=True, trainable=True)
        self.crx29 = tq.CRX(has_params=True, trainable=True)
